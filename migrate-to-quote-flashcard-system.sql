...
-- Step 3: Create the new comprehensive quote-first flashcard system
...
CREATE INDEX idx_flashcard_progress_card_id ON public.flashcard_progress(card_id);
    ...
    IF backup_exists THEN
        ...
        FOR old_quote IN SELECT * FROM quotes_backup LOOP
            ...
            INSERT INTO public.quotes (
                ...
                COALESCE(old_quote.created_by, auth.uid()),
